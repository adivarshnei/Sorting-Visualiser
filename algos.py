    ...
    for i in range(len(nosDict['randNos'])):
        ...
        for j in range(0, len(nosDict['randNos']) - i - 1):
            if nosDict['randNos'][j] > nosDict['randNos'][j + 1]:
                nosDict['randNos'][j], nosDict['randNos'][j + 1] = nosDict['randNos'][j + 1], nosDict['randNos'][j]
                nosDict['colorNos'][j], nosDict['colorNos'][j + 1] = nosDict['colorNos'][j + 1], nosDict['colorNos'][j]
                swapStat = True
...
def selSort(displayType):
    for i in range(len(nosDict['randNos'])):
        ...
        if minIndex != i:
            nosDict['randNos'][i], nosDict['randNos'][minIndex] = nosDict['randNos'][minIndex], nosDict['randNos'][i]
            nosDict['colorNos'][i], nosDict['colorNos'][minIndex] = nosDict['colorNos'][minIndex], nosDict['colorNos'][i]
